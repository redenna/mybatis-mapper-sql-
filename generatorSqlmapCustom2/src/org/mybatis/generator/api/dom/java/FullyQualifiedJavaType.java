...
public class FullyQualifiedJavaType implements
    ...
    private static FullyQualifiedJavaType setInstance = null;
    ...
    public static final FullyQualifiedJavaType getSetInstance() {
        if (setInstance == null) {
        	setInstance = new FullyQualifiedJavaType("java.util.Set<String>"); //$NON-NLS-1$
        }
