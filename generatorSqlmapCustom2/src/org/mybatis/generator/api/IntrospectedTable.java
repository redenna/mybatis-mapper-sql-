...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_BASE_RESULT_MAP_VO_ID,
        ATTR_RESULT_MAP_WITH_BLOBS_VO_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        setBaseResultMapVoId("BaseResultMapVo");
        setResultMapWithBLOBsVoId("ResultMapWithBLOBsVo");
    ...
    public void setResultMapWithBLOBsVoId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_RESULT_MAP_WITH_BLOBS_VO_ID,
                s);
    }
    
    public void setBaseResultMapVoId(String s) {
        internalAttributes.put(InternalAttribute.ATTR_BASE_RESULT_MAP_VO_ID, s);
    }
    ...
    public String getResultMapWithBLOBsVoId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_RESULT_MAP_WITH_BLOBS_VO_ID);
    }

    public String getBaseResultMapVoId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_BASE_RESULT_MAP_VO_ID);
    }
    ...
    public String getFullyQualifiedObj()
    {
    	String pakkage = calculateJavaModelPackage();
