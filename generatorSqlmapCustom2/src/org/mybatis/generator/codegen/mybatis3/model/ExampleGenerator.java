...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        method.addBodyLine("otherColumns = new HashSet<String>();");
        method.addBodyLine("otherBlobColumns = new HashSet<String>();");
        method.addBodyLine("unionTables = new HashSet<String>();");
        ...
        //changeto add otherColumns, getter, setter for distinct
        field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(FullyQualifiedJavaType.getSetInstance());
        field.setName("otherColumns"); //$NON-NLS-1$
        commentGenerator.addFieldComment(field, introspectedTable);
        topLevelClass.addField(field);

        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("setOtherColumns"); //$NON-NLS-1$
        method.addParameter(new Parameter(FullyQualifiedJavaType
                .getSetInstance(), "otherColumns")); //$NON-NLS-1$
        method.addBodyLine("this.otherColumns = otherColumns;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        method.setReturnType(FullyQualifiedJavaType
                .getSetInstance());
        method.setName("getOtherColumns"); //$NON-NLS-1$
        method.addBodyLine("return otherColumns;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        
        //changeto add otherBlobColumns, getter, setter for distinct
        field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(FullyQualifiedJavaType.getSetInstance());
        field.setName("otherBlobColumns"); //$NON-NLS-1$
        commentGenerator.addFieldComment(field, introspectedTable);
        topLevelClass.addField(field);

        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("setOtherBlobColumns"); //$NON-NLS-1$
        method.addParameter(new Parameter(FullyQualifiedJavaType
                .getSetInstance(), "otherBlobColumns")); //$NON-NLS-1$
        method.addBodyLine("this.otherBlobColumns = otherBlobColumns;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        method.setReturnType(FullyQualifiedJavaType
                .getSetInstance());
        method.setName("getOtherBlobColumns"); //$NON-NLS-1$
        method.addBodyLine("return otherBlobColumns;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        topLevelClass.addImportedType(FullyQualifiedJavaType
                .getNewSetInstance());
        topLevelClass.addImportedType(FullyQualifiedJavaType
                .getNewHashSetInstance());
        
        field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(FullyQualifiedJavaType.getSetInstance());
        field.setName("unionTables"); //$NON-NLS-1$
        commentGenerator.addFieldComment(field, introspectedTable);
        topLevelClass.addField(field);
        ...
        String columnArr = buildColumnArr(columns);
        
        FullyQualifiedJavaType stringArrIns = new FullyQualifiedJavaType("java.lang.String[]");
        field = new Field();
        field.setVisibility(JavaVisibility.PUBLIC);
        field.setStatic(true);
        field.setType(stringArrIns);
        field.setName("baseColumnArr");
        field.setInitializationString(columnArr);
        field.setFinal(true);
        topLevelClass.addField(field);
        
        columnArr = buildColumnArr(introspectedTable.getBLOBColumns());
        field = new Field();
        field.setVisibility(JavaVisibility.PUBLIC);
        field.setStatic(true);
        field.setType(stringArrIns);
        field.setName("blobColumnArr");
        field.setInitializationString(columnArr);
        field.setFinal(true);
        topLevelClass.addField(field);
        
        TableConfiguration tableCfg = introspectedTable.getTableConfiguration();
        field = new Field();
        field.setVisibility(JavaVisibility.PUBLIC);
        field.setStatic(true);
        field.setType(FullyQualifiedJavaType.getStringInstance());
        field.setName("tableName");
        field.setInitializationString("\""+tableCfg.getTableName()+"\"");
        field.setFinal(true);
        topLevelClass.addField(field);
        ...
        field.setStatic(true);
        field.setType(FullyQualifiedJavaType.getStringInstance());
        field.setName("tableAlias");
        field.setInitializationString("\""+tableCfg.getAlias()+"\"");
        field.setFinal(true);
        topLevelClass.addField(field);
        ...
        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("setUnionTables"); //$NON-NLS-1$
        method.addParameter(new Parameter(FullyQualifiedJavaType
                .getSetInstance(), "unionTables")); //$NON-NLS-1$
        method.addBodyLine("this.unionTables = unionTables;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        method.setReturnType(FullyQualifiedJavaType
                .getSetInstance());
        method.setName("getUnionTables"); //$NON-NLS-1$
        method.addBodyLine("return unionTables;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        method.addBodyLine("otherColumns.clear();");
        method.addBodyLine("otherBlobColumns.clear();");
        method.addBodyLine("unionTables.clear();");
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        topLevelClass.addInnerClass(getFieldInnerClass(topLevelClass));
    ...
    private InnerClass getCriterionInnerClass(TopLevelClass topLevelClass) {
        ...
        answer.addMethod(getTrimConditionGetter());
    ...
    public static Method getTrimConditionGetter() {
        Method method = new Method();
        method.setName("getTrimCondition");
        method.setReturnType(FullyQualifiedJavaType.getStringInstance());
        method.setVisibility(JavaVisibility.PUBLIC);
        StringBuilder sb = new StringBuilder();
        sb.append("int idx = condition.indexOf('.'); if (idx == -1) return condition; return condition.substring(idx+1);");
        method.addBodyLine(sb.toString());
        return method;
    }
    
    private InnerClass getFieldInnerClass(TopLevelClass topLevelClass) {
        Field field = null;

        InnerClass answer = new InnerClass(new FullyQualifiedJavaType("Field"));
        ...
        columns.addAll(introspectedTable.getPrimaryKeyColumns());
        columns.addAll(introspectedTable.getBaseColumns());
        columns.addAll(introspectedTable.getBLOBColumns());
        
        for (IntrospectedColumn introspectedColumn : columns)
        {
        	String name = introspectedColumn.getTableAlias();
        	if (null == name)
        		name = introspectedColumn.getTableName();
        	String colunmName = introspectedColumn.getActualColumnName();
        	String fieldname = introspectedColumn.getJavaProperty();
        	//String renamedColumn = MyBatis3FormattingUtilities.getRenamedColumnNameForResultMap(introspectedColumn);
        	field = new Field();
            field.setVisibility(JavaVisibility.PUBLIC);
            field.setStatic(true);
            field.setFinal(true);
            ...
            field.setInitializationString("\""+name+"."+colunmName+"\"");
    ...
    private String buildColumnArr(List<IntrospectedColumn> introspectedColumns)
    {
    	StringBuilder columnArr = new StringBuilder();
        columnArr.append("{");
        for (IntrospectedColumn introspectedColumn : introspectedColumns)
        {
        	...
        	if (null == name)
        		name = introspectedColumn.getTableName();
        	String field = introspectedColumn.getActualColumnName();
        	String renamedColumn = MyBatis3FormattingUtilities.getRenamedColumnNameForResultMap(introspectedColumn);
        	columnArr.append('\"');
        	columnArr.append(name);
        	columnArr.append('.');
        	columnArr.append(field);
        	columnArr.append(" as ");
        	columnArr.append(renamedColumn);
        	columnArr.append('\"');
        	columnArr.append(',');
        }
        if (columnArr.charAt(columnArr.length()-1) == ',')
        {
        	columnArr.deleteCharAt(columnArr.length()-1);
        }
        columnArr.append("};");
        return columnArr.toString();
    }
    ...
    private InnerClass getGeneratedCriteriaInnerClass(
        ...
        field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(exampleType);
        field.setName("example"); //$NON-NLS-1$
        answer.addField(field);
        ...
        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("andExample"); //$NON-NLS-1$
        method.setReturnType(FullyQualifiedJavaType.getCriteriaInstance());
        method.addParameter(new Parameter(new FullyQualifiedJavaType("Object"), "otherExample")); //$NON-NLS-1$
        method.addBodyLine("try {");
        method.addBodyLine("java.lang.Class<?> clazz = otherExample.getClass();");
        method.addBodyLine("if(clazz.equals(example.getClass())){");
        method.addBodyLine("return (Criteria) this;");
        method.addBodyLine("}");
        method.addBodyLine("java.lang.reflect.Field field = clazz.getDeclaredField(\"oredCriteria\");");
        method.addBodyLine("List<?> oredCriteria = (List<?>)field.get(otherExample);");
        method.addBodyLine("Object criteria2 = oredCriteria.get(0);");
        method.addBodyLine("clazz = criteria2.getClass();");
        method.addBodyLine("criteria2 = clazz.getMethod(\"getCriteria\").invoke(criteria2);");
        method.addBodyLine("List<?> criterions = (List<?>)criteria2;");
        method.addBodyLine("for (Object crit : criterions){"); //$NON-NLS-1$
        method.addBodyLine("clazz = crit.getClass();");
        method.addBodyLine("field = clazz.getDeclaredField(\"condition\");");
        method.addBodyLine("field.setAccessible(true);");
        method.addBodyLine("String condition = (String)field.get(crit);");
        method.addBodyLine("Criterion criterion = new Criterion(condition);");
        method.addBodyLine("String fields[] = {\"value\", \"secondValue\", \"noValue\", \"singleValue\", \"betweenValue\", \"listValue\", \"typeHandler\"};");
        method.addBodyLine("for (int i=0; i<fields.length; ++i){");
        method.addBodyLine("field = clazz.getDeclaredField(fields[i]);");
        method.addBodyLine("java.lang.reflect.Field field2 = criterion.getClass().getDeclaredField(fields[i]);");
        method.addBodyLine("field.setAccessible(true);");
        method.addBodyLine("field2.setAccessible(true);");
        method.addBodyLine("field2.set(criterion, field.get(crit));");
        method.addBodyLine("}");
        method.addBodyLine("criteria.add(criterion);");
        method.addBodyLine("}");
        method.addBodyLine("clazz = otherExample.getClass();");
        method.addBodyLine("if(example.getClass().equals(clazz))");
        method.addBodyLine("return (Criteria) this;");
        method.addBodyLine("field = clazz.getDeclaredField(\"tableAlias\");");
        method.addBodyLine("String tableAlias = (String)field.get(otherExample);");
        method.addBodyLine("field = clazz.getDeclaredField(\"tableName\");");
        method.addBodyLine("String tableName = (String)field.get(otherExample);");
        method.addBodyLine("boolean bNoContain = example.getUnionTables().add(tableName+\" \"+tableAlias);");
        method.addBodyLine("if (bNoContain){");
        method.addBodyLine("field = clazz.getDeclaredField(\"baseColumnArr\");");
        method.addBodyLine("String[] columnArr = (String[])field.get(otherExample);");
        method.addBodyLine("example.getOtherColumns().addAll(java.util.Arrays.asList(columnArr));");
        method.addBodyLine("field = clazz.getDeclaredField(\"blobColumnArr\");");
        method.addBodyLine("columnArr = (String[])field.get(otherExample);");
        method.addBodyLine("example.getOtherBlobColumns().addAll(java.util.Arrays.asList(columnArr));");
        method.addBodyLine("}");
        method.addBodyLine("} catch (Exception e) {");
        method.addBodyLine("e.printStackTrace();");
        method.addBodyLine("throw new RuntimeException(\"prase criterions failed\");");
        method.addBodyLine("}");
        method.addBodyLine("return (Criteria) this;");
        answer.addMethod(method);
        
        FullyQualifiedJavaType claccJavaType = new FullyQualifiedJavaType("java.lang.Class<?>");
        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("andField"); //$NON-NLS-1$
        method.setReturnType(FullyQualifiedJavaType.getCriteriaInstance());
        method.addParameter(new Parameter(claccJavaType, "field1ExampleCls"));
        method.addParameter(new Parameter(FullyQualifiedJavaType.getStringInstance(), "field1"));
        method.addParameter(new Parameter(FullyQualifiedJavaType.getStringInstance(), "operator"));
        method.addParameter(new Parameter(claccJavaType, "field2ExampleCls"));
        method.addParameter(new Parameter(FullyQualifiedJavaType.getStringInstance(), "field2"));
        method.addBodyLine("addCriterion(field1+\" \"+operator+\" \"+field2);");
        method.addBodyLine("java.lang.Class<?>[] classes = {field1ExampleCls, field2ExampleCls};");
        method.addBodyLine("for (java.lang.Class<?> clazz : classes){");
        method.addBodyLine("try {");
        method.addBodyLine("if (example.getClass().equals(clazz))");
        method.addBodyLine("continue;");
        method.addBodyLine("java.lang.reflect.Field field = clazz.getDeclaredField(\"tableAlias\");");
        method.addBodyLine("String tableAlias = (String)field.get(null);");
        method.addBodyLine("field = clazz.getDeclaredField(\"tableName\");");
        method.addBodyLine("String tableName = (String)field.get(null);");
        method.addBodyLine("boolean bNoContain = example.getUnionTables().add(tableName+\" \"+tableAlias);");
        method.addBodyLine("if (bNoContain){");
        method.addBodyLine("field = clazz.getDeclaredField(\"baseColumnArr\");");
        method.addBodyLine("String[] columnArr = (String[])field.get(null);");
        method.addBodyLine("example.getOtherColumns().addAll(java.util.Arrays.asList(columnArr));");
        method.addBodyLine("field = clazz.getDeclaredField(\"blobColumnArr\");");
        method.addBodyLine("columnArr = (String[])field.get(null);");
        method.addBodyLine("example.getOtherBlobColumns().addAll(java.util.Arrays.asList(columnArr));");
        method.addBodyLine("}");
        method.addBodyLine("} catch (Exception e) {");
        method.addBodyLine("e.printStackTrace();");
        method.addBodyLine("throw new RuntimeException(\"prase Example failed\");");
        method.addBodyLine("}");
        method.addBodyLine("}");
        method.addBodyLine("return (Criteria) this;");
        answer.addMethod(method);
