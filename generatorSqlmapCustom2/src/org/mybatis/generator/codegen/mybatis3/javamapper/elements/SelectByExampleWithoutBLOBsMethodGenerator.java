...
public class SelectByExampleWithoutBLOBsMethodGenerator extends
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        if (introspectedTable.getRules().generateBaseRecordClass()) {
            listType = new FullyQualifiedJavaType(JavaMapperGenerator.BASE_MAPPER_VO_RECORD_TYPE); //"? extends "+introspectedTable.getBaseRecordType()
        } else if (introspectedTable.getRules().generatePrimaryKeyClass()) {
            listType = new FullyQualifiedJavaType("? extends "+introspectedTable
                    .getPrimaryKeyType());
        } else {
