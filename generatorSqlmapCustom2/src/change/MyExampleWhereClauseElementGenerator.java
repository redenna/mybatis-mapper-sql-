 ...
 * 
 */
public class MyExampleWhereClauseElementGenerator extends
        AbstractXmlElementGenerator {

    private boolean isForUpdateByExample;

    public MyExampleWhereClauseElementGenerator(boolean isForUpdateByExample) {
        super();
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("id", "Example_Where_Clause_For_Delete")); //$NON-NLS-1$
    ...
    private XmlElement getMiddleForEachElement(
        ...
        when.addElement(new TextElement("and ${criterion.trimCondition}")); //$NON-NLS-1$
        ...
        sb.setLength(0);
        sb.append("and ${criterion.trimCondition} #{criterion.value"); //$NON-NLS-1$
        if (typeHandled) {
